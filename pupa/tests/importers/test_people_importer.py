...
def create_person():
    # deduplication for people is fairly complicated, it requires a person
    # to have a membership in the jurisdiction's organization and have a
    # matching name.  let's set that up first for the deduplication tests
...
def test_deduplication_no_name_overlap():
    create_jurisdiction()
    create_person()
    # make sure we're not just being ridiculous and avoiding importing
    # anything in the same org
